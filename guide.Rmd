...
- [R for Data Science](http://r4ds.had.co.nz/) by Grolemund & Wickham.  Chapter on _Data Visualization_,  & Chapter on _Graphics for Communication_, & Chapter on _Exploratory Data Analysis_
- [ggplot2: part of the tidyverse](https://ggplot2.tidyverse.org/) -- check out all the cool on-board datasets
- [ggplot2: short tutorial](http://r-statistics.co/ggplot2-Tutorial-With-R.html) by Selva Prabhakaran
- [ggplot cookbook](http://www.cookbook-r.com/Graphs/)  by Winston Chang
- [Data Visualisation](https://rgup.gitlab.io/research_cycle/02_ggplot.html) (web resource)
- [**R Graph Gallery**](http://www.r-graph-gallery.com/)
- [Data Visualization](http://socviz.co/): A practical introduction by Kieran Healy (book)
